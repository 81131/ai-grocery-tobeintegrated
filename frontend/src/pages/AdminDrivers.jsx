...
function AdminDrivers() {
  ...
  const initialFormState = {
    ...
    password: 'DriverPassword123' // Default password for initial setup
  };
      ...
      <div className="card" style={{ padding: 0, overflow: 'hidden' }}>
        {loading ? (
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
            ...
            <tbody>
              {drivers.length === 0 ? (
                <tr><td colSpan="5" style={{ textAlign: 'center', padding: '40px', color: 'var(--text-light)' }}>No delivery drivers registered yet.</td></tr>
              ) : (
                drivers.map(driver => (
